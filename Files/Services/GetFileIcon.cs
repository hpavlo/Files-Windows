...
{
    internal static class GetFileIcon
    {
        public static BitmapSource? GetIcon(string path, FileIconSize fileIconSize)
        {
            IntPtr hIcon;

            switch (fileIconSize)
            {
                case FileIconSize.JumboIcon:
                    hIcon = GetJumboIcon(GetIconIndex(path));
                    break;
                case FileIconSize.ExtraLargeIcon:
                    hIcon = GetExtraLargeIcon(GetIconIndex(path));
                    break;
                case FileIconSize.LargeIcon:
                    hIcon = GetLargeIcon(GetIconIndex(path));
                    break;
                case FileIconSize.SmallIcon:
                    hIcon = GetSmallIcon(GetIconIndex(path));
                    break;
                default: hIcon = IntPtr.Zero;
                    break;
            }
